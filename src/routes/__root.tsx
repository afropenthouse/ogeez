...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium Nigerian cuisine, lounge vibes, karaoke nights and free delivery. Located at E-Center Mall, Sabo-Yaba." },
    ],
    links: [
